...
[![Phase](https://img.shields.io/badge/phase-3_of_5-blueviolet.svg?style=flat)](#roadmap)

## What is this?

ARCHITECT takes a project spec and turns it into working, tested code — autonomously. It decomposes specs into a task DAG, assigns LLM-powered agents, executes in Docker sandboxes, evaluates through 7 layers, and records every mutation in a proposal-gated ledger. 14 components. 5 build phases. 3 fully implemented.
...
You need Python 3.12+, Docker, [uv](https://docs.astral.sh/uv/), and [Bun](https://bun.sh/).

```bash
git clone https://github.com/saatvik333/osoleer-agi.git
cd osoleer-agi
./scripts/dev-setup.sh  # generates .env with passwords
...
| 9 | **Knowledge Memory** | P3 | 5-layer memory hierarchy (L0-L4), pattern extraction, heuristic synthesis |
| 10 | **Economic Governor** | P3 | Real-time budget tracking, progressive enforcement, spin detection |
| 11 | Security Immune | P4 | _stub_ |
| 12 | Deployment Pipeline | P4 | _stub_ |
| 13 | Failure Taxonomy | P4 | _stub_ |
| 14 | **Human Interface** | P3 | Escalation management, approval gates, WebSocket notifications |
...
│   ├── economic-governor/      # [P3] budget tracking + enforcement
│   └── human-interface/        # [P3] escalations + approval gates
├── apps/
...
| **P3** | Intelligence | **done** &mdash; Knowledge Memory, Economic Governor, Human Interface |
| **P4** | Production | _next_ &mdash; Security Immune, Deployment Pipeline, Failure Taxonomy |
| **P5** | Scale | _planned_ |
